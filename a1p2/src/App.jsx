...
function App() {
  const user1 = { name: "Nipun", email: "nipun@example.com" };
  const user2 = { name: "Shaharavat", age: 24, location: "India" };
  ...
  return (
    <>
      ...
      <ButtonClick1 />
      <ToggleButton />
      <Welcome1 name="Nipun Shaharavat" />
      <Greeting message="I am Frontend Web Developer" />
      <UserCard1 {...user1} />
      <ProfileCard {...user2} />
       <Card1>
